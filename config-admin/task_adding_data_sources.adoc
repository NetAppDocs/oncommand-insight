---
permalink: config-admin/task_adding_data_sources.html
sidebar: sidebar
keywords: 
...
. For details about configuration or advanced configuration information required or available for your specific data source, see the link:reference_vendor_specific_data_source_reference.md#[Vendor-specific data source reference].
