---
permalink: config-admin/task_what_the_violations_section_enables_you_to_do.html
sidebar: sidebar
keywords: 
 ...
 ** Click image:../media/delete_icon.gif[] to remove a violation from the list if you determine the issue is no longer a cause for concern.
