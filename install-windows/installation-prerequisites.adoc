...
+
NOTE: OnCommand Insight includes a paid Oracle license for Java SE 8. Customers do not have to buy any additional Java SE 8 licenses. This license covers use of Java SE 8 with all OCI components. Please refer to the link:legal-notices.html[Notices] page for specific details.
