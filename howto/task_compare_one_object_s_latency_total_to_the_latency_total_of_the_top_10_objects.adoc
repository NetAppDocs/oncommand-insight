---
permalink: howto/task_compare_one_object_s_latency_total_to_the_latency_total_of_the_top_10_objects.html
sidebar: sidebar
keywords: 
...
+
The system displays the Top 10 VMs based on Latency - Total. image:../media/guid_7fe726e3_d15f_438a_9d1f_b02fb2daffe9.gif[]
