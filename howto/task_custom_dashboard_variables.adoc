---
permalink: howto/task_custom_dashboard_variables.html
sidebar: sidebar
keywords: 
...
. First, add the City field to the table by selecting it from the column picker image:../media/column_picker_button.gif[] button.
+
...
+
image::../media/customdash_variablecitydialog2.gif[]
