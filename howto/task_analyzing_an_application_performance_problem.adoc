---
permalink: howto/task_analyzing_an_application_performance_problem.html
sidebar: sidebar
keywords: greedy
...
+
image::../media/search_exchange.gif[]
+
[TIP]
====
...
+
image::../media/exch2016_land_page.gif[]
+
 ...
 ** On the right of the charts in the Top contributors section, click on the 100% for the selected internal volume (CDot_Boston:SP2:Vol_01). The system shows this resource is contributing 100% to the Exchange 2016 application. image:../media/top_contributor.gif[]
