---
permalink: howto/task_creating_performance_policies_and_thresholds_for_ports.html
sidebar: sidebar
keywords: 
...
image:../media/port_node_compare.gif[]
...
+
image::../media/node_landing_page.gif[]
...
+
image::../media/node_port_comparison.gif[]
+
